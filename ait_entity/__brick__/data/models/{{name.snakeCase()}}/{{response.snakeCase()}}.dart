...
class {{response}} with _${{response}} {
  const factory {{response}}({
    {{#object}}
    {{#is_object}}
      {{#is_list}}{{#is_snake}}@JsonKey(name:'{{name.snakeCase()}}'){{/is_snake}} List<{{type}}Response>? {{name.camelCase()}},{{/is_list}}
      {{^is_list}}{{#is_snake}}@JsonKey(name:'{{name.snakeCase()}}'){{/is_snake}} {{type}}Response? {{name.camelCase()}},{{/is_list}}
    {{/is_object}}
    {{^is_object}}
